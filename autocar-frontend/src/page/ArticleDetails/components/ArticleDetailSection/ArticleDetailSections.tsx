...
import styles from "./ArticleDetailSection.module.scss";
import type { ArticleSection } from "../../../../types/article/article-detail.type";
...
const ArticleDetailSection = ({ sections }: Props) => (
  <>
